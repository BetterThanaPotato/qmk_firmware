 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |Numpad| Ctrl | Alt  |Super |Lower |ShiftR|Space |Raise |      | Mute | Play |Print |
 * `-----------------------------------------------------------------------------------'
...
[_BASE] = LAYOUT_preonic_grid(
  ...
  NUMPAD,  KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_LCTL, KC_SPC,  RAISE,   _______, KC_MUTE, KC_MPLY, KC_PSCR
),
