...
[_BASE] = LAYOUT_preonic_grid(
  ...
  NUMPAD,  KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_RSFT, KC_SPC,  RAISE,   KC_RALT, KC_PAUS, KC_BRK,  KC_SYRQ
),
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PIPE,
  CW_TOGG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  _______, KC_F21,  KC_F22,  KC_F23,  KC_F24,  XXXXXXX, KC_PSCR, KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______,
  KC_INS,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_VOLU, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_BSLS,
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_VOLD, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),

//remove AG_NORM and AG_SWAP
